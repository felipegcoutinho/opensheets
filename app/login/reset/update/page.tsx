...
export default function ResetPasswordUpdatePage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const msg = encodeURIComponent('Senha atualizada com sucesso! Faça login para continuar.')
  ...
  return (
    <div className="flex flex-col gap-6">
      <Card>
        <CardHeader className="space-y-2 text-center">
          <CardTitle className="text-3xl font-bold">Definir nova senha</CardTitle>
          <CardDescription className="text-muted-foreground normal-case">
