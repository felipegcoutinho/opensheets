...
export default function UseOptions() {
  ...
  const categoriasDespesa = [
    ...
    { id: 5, name: "Compras", icon: ShoppingBag },
    { id: 6, name: "Cuidados pessoais", icon: Scissors },
    { id: 7, name: "Educação", icon: GraduationCap },
    { id: 8, name: "Empréstimos", icon: PiggyBank },
    { id: 9, name: "Lazer e hobbies", icon: Gamepad2 },
    { id: 10, name: "Loteria e Apostas", icon: Stars },
    { id: 11, name: "Mercado", icon: ShoppingCart },
    { id: 12, name: "Moradia", icon: Home },
    { id: 13, name: "Outros", icon: CircleDollarSign },
    { id: 14, name: "Pagamentos", icon: CreditCard },
    { id: 15, name: "Restaurantes", icon: Coffee },
    { id: 16, name: "Roupas", icon: Shirt },
    { id: 17, name: "Saúde", icon: Heart },
    { id: 18, name: "Terceiros", icon: Users },
    { id: 19, name: "Trabalho", icon: Briefcase },
    { id: 20, name: "Transporte", icon: Car },
    { id: 21, name: "Viagem", icon: Plane },
  ];
