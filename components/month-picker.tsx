...
const ReturnButton = ({ onClick, disabled }) => (
  <Button
    variant="link"
    size="xs"
    className="border border-white px-1 text-white disabled:opacity-50 dark:border-white dark:text-white"
    onClick={onClick}
    disabled={disabled}
  >
...
const LoadingSpinner = () => (
  <Loader2 className="h-4 w-4 animate-spin text-alt_yellow dark:text-blue-200" />
);
...
export default function MonthPicker() {
  ...
  return (
    <div className="flex w-full items-center justify-start gap-4 rounded bg-alt_green p-4 dark:bg-alt_green/20">
